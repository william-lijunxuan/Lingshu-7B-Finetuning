...
# Inputs/outputs
CSV_PATH = r"/mnt/d/skinalor/dataset/skin/Derm1M/Derm1M_v2_pretrain.csv".replace("\\", "/")
OUT_PATH = os.path.join(os.path.dirname(CSV_PATH), "eval_Derm1M_train_json_full.jsonl")
