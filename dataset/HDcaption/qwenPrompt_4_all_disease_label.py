...
Normalized disease_label is in the whitelist (file: /root/model/Lingshu-7B-Finetuning/dataset/json/disease_name/derm1m_table10_diseases.txt; fallback to /mnt/data/derm1m_table10_diseases.txt if missing).
...
OUT_PATH = "/root/dataset/skin/Derm1M/Derm1M_v2_pretrain_HD.csv"
DISEASE_LIST = "/root/model/Lingshu-7B-Finetuning/dataset/json/disease_name/derm1m_table10_diseases.txt"
MIN_WORDS = 25
